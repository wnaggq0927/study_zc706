...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_tlast_gen is
  ...
  signal \packet_cnt_reg[31]_i_3_n_2\ : STD_LOGIC;
  signal \packet_cnt_reg[31]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_packet_cnt_reg[31]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_packet_cnt_reg[31]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \packet_cnt_reg[31]_i_3\ : label is 35;
...
\packet_cnt[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0000"
    )
        port map (
...
\packet_cnt_reg[31]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \packet_cnt_reg[28]_i_2_n_0\,
      CO(3 downto 2) => \NLW_packet_cnt_reg[31]_i_3_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \packet_cnt_reg[31]_i_3_n_2\,
      CO(0) => \packet_cnt_reg[31]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_packet_cnt_reg[31]_i_3_O_UNCONNECTED\(3),
