...
namespace eval ::optrace {
  variable script "H:/test/two/fpga_arm/fpga_arm.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet H:/test/two/fpga_arm/fpga_arm.runs/synth_1/design_1_wrapper.dcp
