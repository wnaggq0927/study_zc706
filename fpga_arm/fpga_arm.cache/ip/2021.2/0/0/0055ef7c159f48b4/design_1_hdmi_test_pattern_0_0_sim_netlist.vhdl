...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_test_pattern is
  ...
  signal \hdmi_data[23]_i_10_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \h_cnt[10]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_cnt[11]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \h_cnt[9]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \hdmi_data[23]_i_10\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \hdmi_data[23]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of hdmi_de_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of hdmi_hs_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of hdmi_hs_i_5 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \v_cnt[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \v_cnt[10]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \v_cnt[11]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \v_cnt[11]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \v_cnt[11]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \v_cnt[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \v_cnt[2]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \v_cnt[5]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \v_cnt[8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \v_cnt[9]_i_1\ : label is "soft_lutpair14";
begin
...
\hdmi_data[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"88B888B888B88888"
    )
        port map (
      I0 => \hdmi_data[23]_i_8_n_0\,
      I1 => \hdmi_data[15]_i_4_n_0\,
...
\hdmi_data[15]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\hdmi_data[23]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      ...
      O => \hdmi_data[23]_i_10_n_0\
    );
\hdmi_data[23]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFAFBFAAAAAAAAA"
    )
        port map (
      I0 => \h_cnt_reg_n_0_[11]\,
...
\hdmi_data[23]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \h_cnt_reg_n_0_[4]\,
      I1 => \h_cnt_reg_n_0_[5]\,
      I2 => \hdmi_data[23]_i_9_n_0\,
      I3 => \h_cnt_reg_n_0_[8]\,
      I4 => \h_cnt_reg_n_0_[9]\,
      I5 => \hdmi_data[23]_i_10_n_0\,
...
\hdmi_data[23]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \h_cnt_reg_n_0_[4]\,
      I2 => \hdmi_data[23]_i_9_n_0\,
      I3 => \hdmi_data[23]_i_10_n_0\,
      I4 => \h_cnt_reg_n_0_[8]\,
      I5 => \h_cnt_reg_n_0_[9]\,
      O => \hdmi_data[23]_i_6_n_0\
    );
\hdmi_data[23]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
hdmi_de_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
hdmi_hs_i_2: unisim.vcomponents.LUT6
    generic map(
...
hdmi_hs_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
hdmi_hs_i_4: unisim.vcomponents.LUT6
    generic map(
...
hdmi_hs_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
hdmi_vs_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\v_cnt[11]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\v_cnt[11]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\v_cnt[11]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 72250000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
